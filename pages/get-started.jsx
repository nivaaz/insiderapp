  ...
  return (
    <div className="w-full flex flex-col space-y-8 p-4 pb-16 bg-purple-100 text-black">
          ...
          <div className="md:sticky top-0 h-screen flex">
            <div className="m-auto">
              ...
              <div className="m-auto border border-black rounded-xl p-4 space-y-4">
                <h3 className="text-black italic text-xl">
                  {" "}
                ...
                <p>
                  ...
                  {formValues.motivation ??
                    " Share the cookie love with the world"}{" "}
                </p>
                <p>
                  This collection has {formValues.numberOfNfts} passes. Each
                  pass will have one of the following unique traits:
                  {formValues.trait1Category ?? " cookie flavour"}
                </p>
                {formValues?.passImage && <Image
                  width={200}
                  height={200}
                  alt="pass image"
      ...
      <div className="max-w-xl mx-auto">
        <Button
          copy="Chat with Insider to get started"
          variant="primary"
          onClick={() => {
           window.location = 'https://calendly.com/foundersinsider'
          }}
        />
      </div>
    </div>
