    ...
    <section className="max-w-xl mx-auto">
     ...
     {/*  */}
      <section  className="max-w-xl mx-auto font-para">
        ...
        <label>
          My brand is called
          <input className="mx-1 p-4 bg-white border border-primary-default rounded-full" type="text" />
        </label>
        <label>
        ...
        <label>
          Our website link is
          <input className="mx-1 p-4 bg-white border border-primary-default rounded-full" type="url" />
        </label>
      </section>
