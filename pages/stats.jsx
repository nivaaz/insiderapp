...
const Stats = () => {
  ...
  return (
    <div className="grid m-auto text-center space-y-8 mt-8 min-h-screen">
      <h1 className="font-heading font-bold text-5xl"> Here are some Insider stats </h1>
      <div className="space-y-4"> 
      <p className="font-para text-5xl"> <b className="font-bold">  {numberOfSignUps}</b> email sign ups</p>
